...
const paths = {
  ...
  translate: (
    <>
      <path d="M3.5 5.5h9M8 3.5v2M5.8 5.5c.9 3.3 2.9 5.8 5.7 7.3M10.4 5.5c-.9 3.7-3.1 6.5-6.4 8" />
      <path d="m12.5 20.5 4-9 4 9M13.9 17.3h5.2" />
    </>
  ),
  eyeOff: (
    <>
      <path d="M10.2 5.7a9 9 0 0 1 1.8-.2c6 0 9.5 6.5 9.5 6.5a16 16 0 0 1-2.6 3.4M6.5 6.9A16.4 16.4 0 0 0 2.5 12S6 18.5 12 18.5a9 9 0 0 0 4.6-1.3" />
